...
namespace nv_engine::gl {
  // @brief A list of possible mouse button actions
  ...
  /* @brief Whether a keyboard key has been pressed, released or is held down,
   * causing it to repeat in quick succession.
   **/
